package com.aggregation.integration;
...
import com.aggregation.util.IntegrationUtil;
import com.jcraft.jsch.ChannelSftp.LsEntry;

@Configuration
public class InboundIntegration {
  
  private static Logger logger = Logger.getLogger(InboundIntegration.class);
  ...
  public FileListFilter<LsEntry> filter() {
    ...
    Pattern pattern = Pattern.compile("(?i)^.*\\.xlsx$");
